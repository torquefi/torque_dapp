...
export function Dialog({
  ...
  extraDialogClass = '',
  headerClass = 'relative flex px-4 py-1 box-content bg-[#FFFFFF] z-5 border-top rounded-t border-b border-gray-200 z-10',
  extraHeaderClass = '',
  bodyClass = 'relative p-4 bg-[#FFFFFF] rounded',
  extraBodyClass = '',
  footerClass = 'relative flex px-4 py-2 bg-[#FFFFFF] z-5 rounded-b',
  extraFooterClass = '',
