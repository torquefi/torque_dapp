    ...
    <>
      <div className="ml-0 mr-2 mt-6 h-full w-full rounded-xl border bg-[#FFFFFF] from-[#0d0d0d] to-[#0d0d0d]/0 px-[16px] py-[12px] pb-[20px] pt-[16px] text-[#404040] dark:border-[#1A1A1A] dark:bg-transparent dark:bg-gradient-to-br dark:text-white md:ml-4 md:mr-0 md:mt-0 lg:max-w-[40%] xl:px-[32px]">
        <div className="flex items-center justify-between">
          <h2 className="font-larken text-[#030303] dark:text-white text-[24px] font-[400] leading-[40px]">
            Vote Power
          </h2>
          <Popover
            trigger="hover"
      ...
      ${
        ...
        <div className="flex flex-col">
          ...
          <Link
            ...
            target="_blank"
            className="font-mona mt-2 w-full rounded-full border border-[#AA5BFF] bg-transparent py-1 text-center text-[14px] uppercase text-[#AA5BFF] transition-all"
          >
            acquire torq
          </Link>
        </div>
