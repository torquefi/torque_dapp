  ...
  return (
    <div>
      <Modal
        ...
        className="mx-auto w-[90%] max-w-[360px] bg-[#FFFFFF] px-[24px] dark:bg-[#030303]"
        hideCloseIcon
      >
        <div className="flex items-center justify-between py-2">
          <div className="font-rogan font-[400] text-[#030303] dark:text-white text-[24px]">
            Delegate
          </div>
          <AiOutlineClose
      ...
      ${theme === 'light' ? 'bg-gradient-divider-light' : 'bg-gradient-divider'
        ...
        <button
          ...
          disabled={loading}
          className={`font-rogan-regular mt-[16px] w-full rounded-full border border-[#AA5BFF] bg-gradient-to-b from-[#AA5BFF] to-[#912BFF] py-1 text-[14px] uppercase text-white transition-all hover:border hover:border-[#AA5BFF] hover:from-transparent hover:to-transparent hover:text-[#AA5BFF]
