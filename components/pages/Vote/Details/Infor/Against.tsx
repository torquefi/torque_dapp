...
export const Against = (props: any) => {
  ...
  return (
    <div className="font-rogan mt-[16px] md:mt-0 rounded-xl border border-[#E6E6E6] bg-[#ffffff] from-[#0d0d0d] to-[#0d0d0d]/0 px-[18px] py-[0px] md:px-[24px] pb-4 text-[#030303] md:w-[49%] dark:border-[#1A1A1A] dark:bg-transparent dark:bg-gradient-to-br dark:text-white">
      <div className="flex items-center justify-between">
        <h2 className="text-[24px] font-[400] leading-[60px]">Against</h2>
        <p className="font-rogan-regular font-[500] font-medium leading-[24px] text-[#F05858]">
      ...
      {/* <table className="w-full">
        <thead>
          <tr className="">
            <th className="font-rogan-regular w-[50%] py-[12px] text-left font-[500] leading-[24px] text-[#959595]">
              No voters yet
            </th>
            <th className="font-rogan-regular w-[50%] py-[12px] text-right font-[500] leading-[24px] text-[#959595]">
              Votes
            </th>
          </tr>
        </thead>
      ...
      <div className="font-rogan-regular mt-[12px] cursor-pointer text-center text-[14px] font-[500] uppercase text-[#959595]">
        view all
      </div> */}
    </div>
  )
