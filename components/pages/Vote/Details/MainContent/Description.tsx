...
export const Description = () => {
  return (
    <div className="w-full h-full rounded-[12px] border-[1px] border-solid border-[#1a1a1a] bg-[#0d0d0d] px-[10px] py-[9px] md:w-[55%] md:px-[50px]">
      <div className="flex items-center justify-between">
        <h2 className="text-[24px] font-[400] font-larken mt-4">Description</h2>
        <button>
      ...
      <div className="mt-[24px] text-left">
        <h4 className="text-[18px] font-[400] font-larken leading-[24px]">Introduction</h4>
      ...
      <div className="mt-[24px] text-left">
        <h4 className="text-[18px] font-[400] font-larken leading-[24px]">Motivation</h4>
        <p className="mt-[15px] w-full max-w-[720px] font-[500] text-[#959595]">
          Maecenas vitae rutrum diam. Phasellus nibh massa, rutrum eget placerat
          ut, lacinctus. Proin aliquet et lacus rhoncus blandit. Nullam
          tristique, diam et laoreet gravida, dolor tortor tincidunt urna, nec
      ...
      <div className="mt-[24px] text-left">
        <h4 className="text-[18px] font-[400] font-larken leading-[24px]">Specification</h4>
        <p className="mt-[15px] w-full max-w-[720px] font-[500] text-[#959595]">
          Maecenas vitae rutrum diam. Phasellus nibh massa, rutrum eget placerat
          ut, lacinctus. Proin aliquet et lacus rhoncus blandit. Nullam
          tristique, diam et laoreet gravida, dolor tortor tincidunt urna, nec
