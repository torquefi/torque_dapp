...
export const Description = () => {
  ...
  return (
    <div className="rounded-[12px] border border-[#E6E6E6] bg-[#ffffff]  from-[#0d0d0d] to-[#0d0d0d]/0 text-[#030303] dark:border-[#1A1A1A] dark:bg-transparent dark:bg-gradient-to-br dark:text-white px-[10px] py-[9px] md:px-[24px] h-full">
      <div className="flex items-center justify-between">
        <h1 className="text-[24px] text-[#030303] dark:text-white font-[400] font-larken mt-2">Description</h1>
        <button>
      ...
      <article className='prose text-left mt-10 max-w-[765px] block'>
        <MyMarkdown/>
      </article>
      <div className={`mt-4 h-[1px] w-full block` + `
      ${theme === 'light' ? 'bg-gradient-divider-light' : 'bg-gradient-divider'}`
