export const EmptyBoost = () => {
  return (
    <div className="mt-[24px] overflow-hidden rounded-[12px] border border-neutral-300 from-[#030303] to-[#030303] dark:border-neutral-800 dark:bg-gradient-to-b">
      <div className="flex h-[300px] flex-col items-center w-full justify-center bg-[url(/images/bg-grid-mobile.png)] bg-cover bg-top bg-no-repeat md:bg-[url(/images/bg-grid-desktop.png)]">
        <img className="w-[112px]" src="/images/boost-icon.png" alt="" />
