...
export const SYNTHETICS_ACCEPTABLE_PRICE_IMPACT_BPS_KEY =
  'synthetics-acceptable-price-impact-bps'
...
export const SYNTHETICS_COLLATERAL_DEPOSIT_TOKEN_KEY =
  'synthetics-collateral-deposit-token'
