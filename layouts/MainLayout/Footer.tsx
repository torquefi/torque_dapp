...
export default function Footer() {
  ...
  return (
    <div className="relative mt-[80px] flex w-full justify-center">
      <div
        className={
      ...
      />
      <footer className="flex w-[1280px] sm:text-[13px] xs:text-[12px] max-w-[1280px] justify-between px-4 py-3 text-[#959595] sm:px-8 mb-6 md:mb-0">
        ...
        <div className="flex space-x-8 text-[12px] hidden md:flex">
          {socials.map((item, i) => (
            <Link
              href={item.link}
              key={i}
