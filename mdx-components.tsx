...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    table: ({ children }) => <table className='border-[1px] border-[#959595] dark:border-[#1a1a1a] text-center dark:text-[#959595]'>{children}</table>,
    ...
    th: ({ children }) => <th className='dark:text-[#FFFFFF] text-black border-[1px] border-[#959595] dark:border-[#1a1a1a]'>{children}</th>,
    p: ({ children }) => <p className='text-[#959595] text-[16px] leading-6 mt-0'>{children}</p>,
    li: ({ children }) => <li className='text-[#959595] text-[16px] leading-6 mt-0'>{children}</li>,
    a: ({ children }) => <a className='text-black dark:text-white text-[16px] leading-6 mt-0 cursor-pointer'>{children}</a>,
