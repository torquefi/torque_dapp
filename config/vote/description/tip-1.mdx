...
To fund this initial setup of the liquidity program, 1.44b TORQ shall be allocated for a duration of 90 days with 16m TORQ to be rewarded per day and distributed bi-weekly via airdrop. A sheet has been created for live community tracking of the program’s bi-weekly results [4].
...
|-------------|----------------|--------------|--------------|
| TORQ/WETH   | Uniswap V3 0.3 | Pair TORQ/WETH | 4m         |
| USDC/TUSD   | Uniswap V3 0.01| Pair USDC/TUSD | 4m         |
| TORQ/TUSD   | Summer/Ajna    | Supply TUSD    | 4m         |
| TORQ/USDC   | Summer/Ajna    | Supply USDC    | 4m         |
