...
export const NETWORK_METADATA: { [chainId: number]: any } = {
  [BSС_MAINNET]: {
...
export function getExplorerUrl(chainId: any) {
  if (chainId === 3) {
...
export function getHighExecutionFee(chainId: any) {
  return HIGH_EXECUTION_FEES_MAP[chainId] || 3;
}

export function getExecutionFeeMultiplier(chainId: any) {
